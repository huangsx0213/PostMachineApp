...
public class LenovoMobileForumPost extends BasicForumPost {
    ...
    public void sendPostSteps(WebDriver driver, int i) {
        ...
        WebElement element = driver.findElement(By.id("replyText"));
        //element.clear();
        ...
        //element.submit();
        WebElement reply_btn = driver.findElement(By.id("reply_btn"));
        reply_btn.click();
